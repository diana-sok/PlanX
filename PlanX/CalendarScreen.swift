...
class CalendarScreen: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    weak var collectionView: UICollectionView! //added by diana for now
...
//        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Storyboard.Cellidentifier, for: indexPath) as! Cell
